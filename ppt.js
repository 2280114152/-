(() => {
    ...
    function getHtml() {
        ...
        <div id="hcq-content-left">
            <img src="http://q1.qlogo.cn/g?b=qq&nk=740555801&s=640" alt="用户头像">
            <div class="left-item">
                <span>用户名</span>
        ...
        <div id="hcq-content-right">
            ...
            <div class="menu-item flex" id="menubar">
                ...
                <div data-type="feedback">
                    <a target="_blank" href="https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=740555801@qq.com">反馈意见</a>
                </div>
